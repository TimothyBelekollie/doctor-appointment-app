...
<body style="background:radial-gradient(lightyellow,rgb(3, 125, 42));">
    <div class="container min-h-screen  bg-center bg-cover px-28 py-5 relative">
        <nav class="flex items-center">
            <img src="{{('images/logo.png')}}" alt="" class="w-40 cursor-pointer">
            ...
            <li class="list-none inline-block px-5"><a href="{{ route('login') }}"  class="no-underline text-white px-2">Get Started <span class="text-lg inline-block">&#10148;</span></a></li>
        </nav>
<div class="flex">
        <div class="text-white mt-48 max-w-xl flex-1">
           <h1 class="text-4xl font-semibold leading-normal">Real Time Appointment <br> App <span class="font-light">24hrs-monday-friday</span> </h1>
           <p>Our real-time appointment app is a user-friendly and efficient solution designed to streamline the appointment booking process.</p> 

           <div class="mt-10">
            <a href="#" class="bg-yellow-300 rounded-3xl py-3 px-8 font-medium inline-block mr-4 hover:bg-transparent hover:border-yellow-300 hover:text-white during-300 hover:border border border-transparent">Contact Us</a>
           
            <a href="#" class="bg">Download App <span class="text-lg inline-block rotate-90">&#10148;</span>
                </a>
           </div>
        </div>
        <img src="{{('images/backgroundremover.png')}}" alt=""
        class="w-full flex-1">

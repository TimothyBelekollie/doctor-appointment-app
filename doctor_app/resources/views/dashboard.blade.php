<x-app-layout>
    ...
    <div class="min-h-screen py-12 ">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-4   gap-10 items-center justify-between bg-gray-100 py-10 ">
                ...
                <div class="container mx-auto pr-4 ">
                    ...
                    <p class="py-4 text-3xl ml-5">{{ $appointmentCount }}</p>
                    ...
                    <div class="w-72 bg-white max-w-xs mx-auto rounded-sm overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-100 cursor-pointer">
                        ...
                        if (isset($reviews) && is_array($reviews)) {
                            ...
                            if ($count != 0) {
                                ...
                                $rating = $total / $count; // Calculate average rating
                            }
                        }
                    @endphp
